                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                >
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 focus:border-[#134e4a] focus:ring-2 focus:ring-[#134e4a]/20 outline-none transition-all"
                                        />
                                    </div>
                                </motion.div>
                            )}
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-12 py-3 rounded-xl border border-gray-200 focus:border-[#134e4a] focus:ring-2 focus:ring-[#134e4a]/20 outline-none transition-all"
                                    />
                                    <button
                                        type="button"
                            ...
                            {authMode === 'signin' && (
                                <div className="flex justify-end">
                                    <button type="button" className="text-sm font-medium text-[#134e4a] hover:text-[#0f3f3c]">
                                        Forgot password?
                                    </button>
                                </div>
                            )}
                            ...
                            <button
                                type="submit"
                                className="w-full bg-[#134e4a] text-white font-bold py-3.5 rounded-xl hover:bg-[#0f3f3c] transition-all shadow-lg shadow-[#134e4a]/20 flex items-center justify-center gap-2 group"
                            >
